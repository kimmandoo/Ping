...
import com.ping.app.tokenDataStore
...
class LoginRepoImpl private constructor(context: Context) : LoginRepo {
    ...
    override suspend fun setAccessToken(uid: String) {
        appContext.tokenDataStore.edit { prefs ->
            prefs[PingApplication.UID_TOKEN] = uid
        }
    }
    
    override suspend fun getAccessToken(): String {
        val userAccessToken: Flow<String?> = appContext.tokenDataStore.data.map {
            it[PingApplication.UID_TOKEN]
        }
